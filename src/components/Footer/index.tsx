    ...
    <>
      <footer className="relative z-10 pb-17.5 lg:pb-22.5 xl:pb-27.5">
        ...
        <div className="absolute bottom-0 left-0 w-full flex flex-col gap-3 -z-1 opacity-50">
          <div className="w-full h-[1.24px] footer-bg-gradient">He</div>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 relative pt-17.5">
          ...
          <div className="flex flex-wrap justify-between">
            ...
            Rose Development created ai solutions needing custom solutions for buisness owners. We work with you to create a solution that fits your needs and budget. We Create Quality.
              </p>
              ...
              <p className="font-medium mt-5.5">
                Rose Development, LLC. All rights reserved.
              </p>
            </div>
